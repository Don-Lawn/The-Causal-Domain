...
![TranslatedStateVector](../figures/TranslatedStateVector.png)
...
![TwoTravellers](../figures/TwoTravellers.png)
...
Equation (23) assumes that the force and the acceleration are aligned along the same vector.  
...
![MassIncreaseExternal](../figures/MassIncreaseExternal.png)
...
![EffectiveThrust](../figures/EffectiveThrust.png)
