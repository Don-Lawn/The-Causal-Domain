...
export function makeCylinder(params) {
    ...
    export function makeTriangularPrism(hints) {
        ...
        const width            = hints["geometry.width"];
        const height           = hints["geometry.height"];
        const depth            = hints["geometry.depth"];
        const triangleType     = hints["geometry.triangleType"];
        const rightAngleCorner = hints["geometry.rightAngleCorner"];

        const color            = hints["semantic.color"];
